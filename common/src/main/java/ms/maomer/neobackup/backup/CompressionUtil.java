...
public class CompressionUtil {
    ...
    private static boolean shouldSkip(Path file, NeoBackupConfig config) {
        List<String> excluded = config.getExcludedFiles();
    ...
    public static void compressWithZstd(Path sourceDir, Path targetFile, NeoBackupConfig config) throws IOException {
    ...
    public static void compressWithZip(Path sourceDir, Path targetFile, NeoBackupConfig config) throws IOException {
