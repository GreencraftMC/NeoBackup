...
public class NeoBackupConfig {
    ...
    public static class Common {
        ...
        public Common(ModConfigSpec.Builder builder) {
            ...
            compressionMethod = builder
                ...
                .define("compressionMethod", "zip", NeoBackupConfig::isValidCompressionMethod);
            backupPath = builder
                .comment(
                    "Backup storage path.",
                    "Supported formats:",
                ...
                .define("backupPath", "./backups", NeoBackupConfig::isValidPath);
    ...
    public static String getCompressionMethod() {
        return COMMON.compressionMethod.get().toLowerCase();
    }
}
